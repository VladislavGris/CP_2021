...
{
    class AddNewChildCommand : IUndoRedoCommand
    {
        private ProductionTask _parent;
        private ProductionTask _task;
        private ApplicationUnit _unit;

        public AddNewChildCommand(ProductionTask parent, ProductionTask task)
        {
            _parent = parent;
            _task = task;
        ...
        public void Redo()
        {
            ...
            {
                ProductionTask topTask = (ProductionTask)_parent.Children[taskPosition - 2];
